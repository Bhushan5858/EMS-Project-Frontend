...
const Departments = () => {
    ...
    if (role === "manager" && departments.length === 0 && !isLoading) {
        return (
            <div className="flex-1 p-8 bg-slate-50 dark:bg-slate-950 min-h-full flex flex-col items-center justify-center transition-colors">
                <div className="bg-white dark:bg-slate-800 p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200 dark:shadow-none border border-slate-100 dark:border-slate-700 text-center max-w-lg">
        ...
        <div className="flex-1 p-4 sm:p-6 lg:p-8 bg-slate-50/50 dark:bg-slate-950 min-h-full transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto space-y-10">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-3">
                            <div className="p-2.5 sm:p-3 rounded-2xl bg-slate-900 dark:bg-teal-600 text-white shadow-xl shadow-slate-200 dark:shadow-none">
                                <LayoutGrid size={24} />
                            </div>
                ...
                {isLoading ? (
                    ...
                    <div className="text-center py-32 bg-white dark:bg-slate-800 rounded-[3rem] border border-dashed border-slate-200 dark:border-slate-700 flex flex-col items-center">
